    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center px-4">
        <div className="flex items-center gap-4">
          ...
          {user?.role === "pro" ? (
            <Link href="/pricing" className="rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs font-bold px-4 py-1.5 shadow-sm flex items-center gap-2 hover:from-yellow-500 hover:to-orange-600 transition">
