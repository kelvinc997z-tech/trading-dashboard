...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 to-gray-800 flex flex-col">
      <Header />
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">Sign in to your Trading Dashboard</p>
          </div>
          ...
          {(formError || error) && (
            <div className="p-3 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-200 rounded-lg text-sm">
              {formError || (error === "AccessDenied" ? "Access denied" : "Authentication error")}
            </div>
          )}
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#00A4EF] hover:bg-[#0089D0] text-white rounded-lg transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M11.5 11.5H0V0h11.5v11.5zM23.5 11.5H12V0h11.5v11.5zM11.5 23.5H0V12h11.5v11.5zM23.5 23.5H12V12h11.5v11.5z"/>
              </svg>
              {socialLoading === "microsoft" ? "Connecting..." : "Sign in with Microsoft"}
            </button>
          </div>
